...
import { ALPHABET_STD, ALPHABET_URL } from './base64';
...
// Los alfabetos NO se declaran aquí: son los de `base64.ts` (T6.6), que es el dueño único de
// las tablas de la RFC 4648 desde que allí vive también el decodificador. Codificar y
// decodificar deben leer LA MISMA tabla o pueden divergir sin que ningún test lo note.
