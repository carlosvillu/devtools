...
| **F7** · Compartir la receta | Una composición se comparte con un enlace (`/compose?r=…`) que lleva **solo la receta** —nunca el fuente ni el secreto—; quien lo abre ve los pasos precargados y mete su propio valor. El servidor genera una **imagen OG** con los pasos para que el enlace tenga preview rico. Fiel a la privacidad: se comparte la receta, no el dato (D11, O9)                                                                                                                                    | 🔨 4/5      |
